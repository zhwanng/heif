...
public final class HEVCSample extends VideoSample {
     ...
     * @throws Exception
     */
    public HEVCSample(HEIF heif, byte[] decoderConfig, byte[] data, long duration) throws Exception {
        this(heif);
        try {
     ...
     * @throws Exception
     */
    public HEVCSample(HEIF heif, HEVCDecoderConfig config, byte[] data, long duration) throws Exception {
        this(heif);
        try {
