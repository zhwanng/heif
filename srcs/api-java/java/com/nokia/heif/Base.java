...
public abstract class Base {
     ...
     */
    protected Base(HEIF heif) throws Exception {
        if (heif == null) {
     ...
     */
    protected void checkParameter(Object handle) throws Exception {
        if (handle == null) {
     ...
     */
    protected void checkParameterAllowNull(Base handle) throws Exception {
        if (handle != null) {
